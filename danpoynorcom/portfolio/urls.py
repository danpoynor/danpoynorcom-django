...
urlpatterns = [
    ...
    path("portfolio/clients/<slug:slug>/page/<int:page>/<str:order>/", views.ClientProjectsListView.as_view(), name="client_page_order"),
    ...
    path("portfolio/industries/<slug:slug>/page/<int:page>/<str:order>/", views.IndustryProjectsListView.as_view(), name="industry_page_order"),
    ...
    path("portfolio/markets/<slug:slug>/page/<int:page>/<str:order>/", views.MarketProjectsListView.as_view(), name="market_page_order"),
    ...
    path("portfolio/media-types/<slug:slug>/page/<int:page>/<str:order>/", views.MediaTypeProjectsListView.as_view(), name="mediatype_page_order"),
    ...
    path("portfolio/roles/<slug:slug>/page/<int:page>/<str:order>/", views.RoleProjectsListView.as_view(), name="role_page_order"),
